...
orch.publish_data(X_train, 'dsherman', 'J00040', 'train', 'x' )
orch.publish_data(y_train, 'dsherman', 'J00040', 'train', 'y' )
orch.publish_data(X_test, 'dsherman', 'J00040', 'test', 'x' )
orch.publish_data(y_test, 'dsherman', 'J00040', 'test', 'y' )
...
# no return
params = us.get_architecture('dsherman','J00001')
orch.create_network('dsherman', 'J00001', params)
...
# no return
orch.train_network('dsherman', 'J00001', 'data')
...
orch.eval_network('dsherman', 'J00040', 'test')
...
orch.predict('dsherman', 'J00040', 'test')
