...
orch.publish_data(X_train, 'dsherman', 'J00031', 'train', 'x' )
orch.publish_data(y_train, 'dsherman', 'J00031', 'train', 'y' )
orch.publish_data(X_test, 'dsherman', 'J00031', 'test', 'x' )
orch.publish_data(y_test, 'dsherman', 'J00031', 'test', 'y' )
...
# no return
orch.create_network('dsherman', 'J00031')
...
# no return
orch.train_network('dsherman', 'J00031', 'UI_Test')
...
orch.eval_network('dsherman', 'J00031', 'test')
...
orch.predict('dsherman', 'J00031', 'test')
